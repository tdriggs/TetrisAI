...
void Serializer::RecordFrame(const Game& game, bool hold)
{
	// Collect Inputs
	...
	const Matrix& boardMatrix = game.GetPlainGameBoard();
	...
	int frame = hold? -1 : game.GetCurrentPiece().getFrameIndex();
